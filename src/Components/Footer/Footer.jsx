import { FaTwitter, FaYoutube, FaFacebook, FaGithub, FaInstagram, FaLinkedin } from "react-icons/fa";
import { FaEnvelope, FaMapMarkerAlt, FaPhoneAlt, FaWhatsapp } from "react-icons/fa";

const Footer = () => {
    return (
        <footer className="bg-base-100 shadow-md rounded p-6 md:p-10 mt-6 text-center">
            {/* Contact Section */}
            <div className="flex flex-col md:flex-row flex-wrap gap-4 md:gap-8 items-center justify-center text-base md:text-lg">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm md:text-base">syednazmusshakib94@gmail.com</span>
                </div>
                <div className="flex items-center gap-2">
